...
<div class="container">
    ...
    <form action="${context}/update-product" method="post" onsubmit="return dialogConfirmationUpdateProduct()">
        <div class="form-group">
            <label for="product_id">ProductId:</label>
            <input type="text" class="form-control" id="product_id"
                   name="id" value="${product.id}" readonly="true">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="createdTime" placeholder="Enter Description"
                   name="createdTimeFormat" type="date" value="${createdTime}"/>
        </div>
        <div class="form-group">
            <label>Status:</label>
